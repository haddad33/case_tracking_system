...
<?php
			if(isset($_POST['Update']))
            {
                ...
                $sql = "UPDATE mana_Line_tbl SET `order_Designing` =CURRENT_TIMESTAMP,`order_Designing_Status`=1 WHERE `order_Number`='$updateorder'"; 
...
<title>Digital Beauty Dental Lab || Designing Step</title>
...
<div class="container">
	<h2>Designing Step </h2>	
	<br>
    
    
    <div class="panel panel-default">
                        <div class="panel-heading">
                          Designing Cases Updater 
                        </div>
 ...
 <?php 
    ...
    $sql = "SELECT order_tbl.order_Id, order_tbl.order_Number, mana_Line_tbl.order_Received,mana_Line_tbl.order_Designing_Status,mana_Line_tbl.impression_Pouring,TIMEDIFF(mana_Line_tbl.order_Received, CURRENT_TIMESTAMP) AS 'sd' FROM `mana_Line_tbl` JOIN order_tbl on order_tbl.order_Number=mana_Line_tbl.order_Number WHERE mana_Line_tbl.`order_Designing_Status` = 0 ";
$query = $dbh -> prepare($sql);
$query->execute();
