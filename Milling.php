...
<?php
			if(isset($_POST['Update']))
            {
                ...
                $sql = "UPDATE mana_Line_tbl SET `order_Milling` =CURRENT_TIMESTAMP,`order_Milling_Status`=1 WHERE `order_Number`='$updateorder'"; 
               ...
               $count=$query->rowCount();
                ...
                else{header("Location:Milling.php");}
...
<title>Digital Beauty Dental Lab || Milling Step</title>
...
<div class="container">
 ...
 <?php 
    ...
    $sql = "SELECT order_tbl.order_Id, order_tbl.order_Number, mana_Line_tbl.order_Received,mana_Line_tbl.order_Milling_Status,mana_Line_tbl.order_Milling,TIMEDIFF(mana_Line_tbl.order_Received, CURRENT_TIMESTAMP) AS 'sd' FROM `mana_Line_tbl` JOIN order_tbl on order_tbl.order_Number=mana_Line_tbl.order_Number WHERE mana_Line_tbl.`order_Milling_Status` = 0 ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->order_Milling);?></td>
